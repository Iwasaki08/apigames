...
@clearstack
@bg storage ="titleh.jpg" time=100
@wait time = 200

*start 

[button x=200 y=500 graphic="title/buttonh_start.png" enterimg="title/buttonh_start2.png"  target="gamestart" keyfocus="1"]
[button x=800 y=500 graphic="title/buttonh_load.png" enterimg="title/buttonh_load2.png" role="load" keyfocus="2"]
[button x=1100 y=650 graphic="title/button_syu.png" enterimg="title/button_syu2.png" target="ressult" keyfocus="3"]
